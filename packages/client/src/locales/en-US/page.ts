export default {
  ...
  'page.login.forget.password': 'Forgot password',
  'page.login.submit': 'Log in',

  // forget-pass
  'page.forget.password.username.required': 'Please input your username!',
  'page.forget.password.username.placeholder': 'Username',
  'page.forget.password.email.required': 'Please input your email!',
  'page.forget.password.email.placeholder': 'Email',
  'page.forget.password.captcha.required': 'Please input your captcha!',
